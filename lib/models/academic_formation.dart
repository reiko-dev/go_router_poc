...
enum AcademicSituation implements Labeled {
  interrupted,
  finished,
  finishing;
  ...
  factory AcademicSituation.fromJson(String source) =>
      AcademicSituation.fromMap(json.decode(source) as Map<String, dynamic>);
...
enum Formation implements Labeled {
  firstGrau,
  secondGrau,
  technic,
  graduation,
